...
function buildEmailHtml(link: string, name: string, logoUrl: string) {
  ...
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;color:#e5e7eb;">
    <div style="text-align:center;margin-bottom:32px;">
      ...
      <h1 style="margin:20px 0 6px;font-size:26px;color:#fff;letter-spacing:-0.5px;">Welcome, ${name}!</h1>
    ...
    <p style="margin-top:24px;text-align:center;color:#6b7280;font-size:12px;">Link expires in 24 hours. Didn't sign up? Ignore this email.<br>© DeveloperX</p>
  </div></body></html>`;
}
